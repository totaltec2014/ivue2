...
externaliniURL = base64.b64decode(b'aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL2p1bGVzZ3VpZGUvanVsZXNndWlkZS9tYXN0ZXIv')
...
def add_dexini():
    TheseAddons   =  [dex]#Jules: only run for dexter!!
...
def GetDexVariables(FoundAddon):
    Addon    =  xbmcaddon.Addon(FoundAddon) 
    addre_ss =  Addon.getSetting('lehekylg') 
    po_rt =  Addon.getSetting('pordinumber') 
